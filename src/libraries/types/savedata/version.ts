...
export type CurrentPluginVersion = "0.6.1-NEXT" & PluginVersion;
export const CURRENT_PLUGIN_VERSION: CurrentPluginVersion = "0.6.1-NEXT";
...
export const CURRENT_DATA_VERSION: CurrentPluginVersion = "0.6.1-NEXT";
