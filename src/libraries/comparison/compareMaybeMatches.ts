import {CharacterMaybeMatchResult} from "../../unicode-search/components/characterSearch";
...
export function compareMaybeMatches(left: CharacterMaybeMatchResult, right: CharacterMaybeMatchResult): Order {
