import {CharacterMatchResult} from "../../unicode-search/components/characterSearch";
import {Order} from "../order/order";

export function compareMatchScores(left: CharacterMatchResult, right: CharacterMatchResult): Order {
