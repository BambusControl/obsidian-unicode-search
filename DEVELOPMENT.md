...
The version numbering scheme uses `CURRENT-NEXT` format (e.g., if releasing 0.7.3, the next development version is `0.7.3-NEXT`, not `0.7.4-NEXT-NEXT`). This allows flexibility to decide whether the next release will be patch, minor, or major.
